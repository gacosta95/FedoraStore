...
def lin():
    print("\033[1;4;33m#\033[m"*109)

#Atualizando sistema
print("\033[1;34mAtualizando lista de pacotes, isso pode levar alguns minutos...")
...
def tela():
    lin()
    print("||                                      \033[4;32mMinimalist installation of programs\033[m                                         ||")
    lin()
